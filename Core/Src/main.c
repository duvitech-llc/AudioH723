...
ALIGN_32BYTES(uint16_t rx_buf[2]);
ALIGN_32BYTES(uint16_t tx_buf[2]);
...
/* Configure the peripherals common clocks */
  ...
  printf("Packburn Copyright 2022\r\n");
  printf("Packburn Algo v1.9\r\n\r\n");
  ...
  // initialize
  dq_init(&audio_queue, DAC_SEPARATION + 1U);
  ...
  ((GPIO_TypeDef*) LED_L_GPIO_Port)->BSRR = (uint32_t) LED_L_Pin; // set pin
  ((GPIO_TypeDef*) LED_R_GPIO_Port)->BSRR = (uint32_t) LED_R_Pin; // set pin
  ((GPIO_TypeDef*) ERR_LED_GPIO_Port)->BSRR = (uint32_t) ERR_LED_Pin << 16U; // reset pin
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_GREEN_Pin|ERR_LED_Pin|sample_timing_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CORRECT_R_Pin|CORRECT_L_Pin|LED_YELLOW_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, USB_FS_PWR_EN_Pin|LED_L_Pin|LED_R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CORRECT_R_Pin CORRECT_L_Pin */
  GPIO_InitStruct.Pin = CORRECT_R_Pin|CORRECT_L_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : BLANKER_R_Pin BLANKER_L_Pin */
  GPIO_InitStruct.Pin = BLANKER_R_Pin|BLANKER_L_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : LED_L_Pin LED_R_Pin */
  GPIO_InitStruct.Pin = LED_L_Pin|LED_R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /*Configure GPIO pin : sample_timing_Pin */
  GPIO_InitStruct.Pin = sample_timing_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(sample_timing_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SAI_RxCpltCallback(SAI_HandleTypeDef *hsai) {
	...
	// process adc data
		...
		sample_count++;
		// ((GPIO_TypeDef*) DETECT_K_GPIO_Port)->BSRR = (uint32_t) DETECT_K_Pin << 16U;
}
